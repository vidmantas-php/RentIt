...
function getSteps() {
  return ["Select campaign settings", "Create an ad group", "Create an ad", "Create an bag"];
}

function firstStep({category, handleChange}) {
    return (
    <div>
...
function getStepContent(step) {
  ...
  switch (step) {
    ...
    case 2:
      ...
      case 3:
        return "This is the bit I really care ahah!";
    default:
      return "Unknown step";
  }
}
